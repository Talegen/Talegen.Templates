...
namespace Talegen.Templates
{
    ...
    public static class CommonTokens
    {
        ...
        public const string UserPictureUrl = "USERPICTUREURL";
        ...
        public const string TranslationJobName = "TRANSLATIONJOBNAME";
        public const string TranslationLanguages = "TRANSLATIONLANGUAGES";
        public const string ImportedFiles = "IMPORTEDFILES";
        public const string TextImportedFiles = "TEXTIMPORTEDFILES";
        public const string SupportEmail = "SUPPORTEMAIL";
        public const string SupportInfo = "SUPPORTINFO";
